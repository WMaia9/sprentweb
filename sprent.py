...
floor_area = st.sidebar.slider("Area Total (m²)", 15, 500, 80)
bedrooms = st.sidebar.slider("Quartos", 0, 10, 1)
bathrooms = st.sidebar.slider("Banheiros", 0, 10, 1)
vacancies = st.sidebar.slider("Vagas de Estacionamento", 0, 10, 1)
...
furnished = st.sidebar.selectbox('Reformado', list(['No', 'Yes']))
